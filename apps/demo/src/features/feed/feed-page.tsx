    ...
    <div className="flex min-h-screen justify-center bg-[#f8f8f8]">
      <aside className="flex h-screen w-[357px] flex-col justify-between overflow-hidden px-[10px] py-[25px]">
        <div className="flex flex-col items-center gap-5">
          ...
          <p className="font-montserrat text-sm leading-[1.22] text-black/80">
            Проєкт демонструє роботу сервісу персоналізованих рекомендацій на
            прикладі фільмів.
          </p>
          <hr className="w-full border-black/10" />
          <p className="font-montserrat text-sm leading-[1.22] text-black/80">
            Демо проєкт реалізований для дипломної роботи по темі
            &quot;Програмна система для формування персоналізованих рекомендацій
            контенту&quot;
          </p>
        </div>
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-[10px] rounded-[10px] bg-white p-[10px]">
            ...
            <p className="flex-1 font-montserrat text-sm leading-[1.22] text-black/80">
              Привіт <span className="font-bold">{displayName}</span>!
            </p>
            <button
              type="button"
              onClick={onLogout}
      ...
      <aside className="flex h-screen w-[370px] flex-col gap-[10px] overflow-hidden px-[10px] py-[25px]">
        <div className="flex flex-col items-center gap-5">
          ...
          <p className="font-montserrat text-sm leading-[1.22] text-black/80">
            Логування необхідне для демонстрації системи рекомендацій, та як дії
            користувача впливають на неї
          </p>
          <hr className="w-full border-black/10" />
        </div>
        <div className="flex h-[780px] flex-col justify-end gap-[10px] overflow-y-auto rounded-[15px] p-[10px]">
          {actionLog}
        </div>
      </aside>
    </div>
